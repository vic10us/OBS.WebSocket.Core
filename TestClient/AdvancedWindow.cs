...
namespace TestClient
{
    ...
    {
        // Source to test on
        private const string SOURCE_NAME = "Main";
        ...
        private void _obs_SourceFiltersReordered(OBSWebsocket sender, string sourceName, List<FilterReorderItem> filters)
        {
        ...
        private void _obs_RecordingStateChanged(OBSWebsocket sender, OutputState type)
        {
